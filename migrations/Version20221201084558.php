 ...
 */
final class Version20221201084558 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE attack (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(45) NOT NULL, avatar VARCHAR(255) DEFAULT NULL, cost INT DEFAULT 1 NOT NULL, gain INT DEFAULT 1 NOT NULL, success_rate INT DEFAULT 100 NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE unicorn (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(45) NOT NULL, avatar VARCHAR(255) DEFAULT NULL, score INT DEFAULT NULL, fights INT DEFAULT 0, won_fights INT DEFAULT 0, lost_fights INT DEFAULT 0, ko_fights INT DEFAULT 0, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, firstname VARCHAR(45) NOT NULL, lastname VARCHAR(45) NOT NULL, nickname VARCHAR(45) NOT NULL, avatar VARCHAR(255) DEFAULT \'avatar.png\', updated_at DATETIME NOT NULL, description LONGTEXT DEFAULT NULL, score INT DEFAULT 1000, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), UNIQUE INDEX UNIQ_8D93D649A188FE64 (nickname), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
